...
class Cart extends React.Component {
    ...
    handleDeleteClick = (event) => {
        if(confirm("Do you really want delete this item?")) {  //powiadomienie przy usuwaniu z koszyka. Jak confirm = true, czyli po nacisnieciu OK to wtedy dzieje sie fetch
